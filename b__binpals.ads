...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_binpals" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#66ddbd26#;
   pragma Export (C, u00001, "binpalsB");
   ...
   u00124 : constant Version_32 := 16#a347755d#;
   pragma Export (C, u00124, "ada__text_io__modular_auxB");
   u00125 : constant Version_32 := 16#0d2bef47#;
   pragma Export (C, u00125, "ada__text_io__modular_auxS");
   u00126 : constant Version_32 := 16#3e932977#;
   pragma Export (C, u00126, "system__img_lluB");
   u00127 : constant Version_32 := 16#50eaec78#;
